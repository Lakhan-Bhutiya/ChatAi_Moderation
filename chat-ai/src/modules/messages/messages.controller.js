...
var http_rate_limit_guard_1 = require("../../../../../../../../../src/common/guards/http-rate-limit.guard");
var redis_http_rate_limit_guard_1 = require("../../../../../../../../../src/common/guards/redis-http-rate-limit.guard");
var MessagesController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, http_rate_limit_guard_1.HttpRateLimitGuard, redis_http_rate_limit_guard_1.RedisHttpRateLimitGuard), (0, common_1.Controller)('messages'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var MessagesController = _classThis = /** @class */ (function () {
        ...
        MessagesController_1.prototype.getRoomMessages = function (req, roomId, limit, before) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    // req.user.id is now trusted
                    return [2 /*return*/, this.messagesService.getRoomMessages(roomId, limit ? Number(limit) : 50, before ? new Date(before) : undefined)];
                });
            });
        };
    ...
    (function () {
        ...
        _getRoomMessages_decorators = [(0, common_1.Get)()];
