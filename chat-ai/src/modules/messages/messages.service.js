...
var MessagesService = function () {
    ...
    var MessagesService = _classThis = /** @class */ (function () {
        function MessagesService_1(messageRepo) {
            this.messageRepo = messageRepo;
        }
        MessagesService_1.prototype.getRoomMessages = function (roomId_1) {
            return __awaiter(this, arguments, void 0, function (roomId, limit, before) {
                var qb, messages;
                    ...
                    switch (_a.label) {
                        case 0:
                            qb = this.messageRepo
                                ...
                                .take(limit);
                            if (before) {
                                qb.andWhere('m.createdAt < :before', { before: before });
                            }
                            return [4 /*yield*/, qb.getMany()];
                        case 1:
                            messages = _a.sent();
                            return [2 /*return*/, messages.reverse()]; // oldest → newest
                    }
                });
            });
        };
