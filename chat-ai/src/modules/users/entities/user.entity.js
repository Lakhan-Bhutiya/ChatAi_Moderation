...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function () {
        function User_1() {
            ...
            // ---------- Reputation ----------
            this.reputationScore = (__runInitializers(this, _username_extraInitializers), __runInitializers(this, _reputationScore_initializers, void 0));
            ...
            // ---------- Meta ----------
            this.createdAt = (__runInitializers(this, _warningIssued_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
    ...
    (function () {
        ...
        _username_decorators = [(0, typeorm_1.Index)({ unique: true }), (0, typeorm_1.Column)({ type: 'varchar', length: 100 })];
        _reputationScore_decorators = [(0, typeorm_1.Column)({ type: 'int', default: 50 })];
        _tier_decorators = [(0, typeorm_1.Column)({
                type: 'enum',
                enum: ReputationTier,
                default: ReputationTier.NEUTRAL,
            })];
        _cleanMessageCount_decorators = [(0, typeorm_1.Column)({ type: 'int', default: 0 })];
        _warningIssued_decorators = [(0, typeorm_1.Column)({ type: 'boolean', default: false })];
